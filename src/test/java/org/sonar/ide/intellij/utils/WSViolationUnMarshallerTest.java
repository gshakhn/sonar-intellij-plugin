...
public class WSViolationUnMarshallerTest {
    ...
    public void testUnmarshallViolation() throws Exception {
        ...
        assertViolationData(violation, 39, "Name 'pomodoroIcon' must match pattern '^[A-Z][A-Z0-9]*(_[A-Z0-9]+)*$'.", "MINOR", "com.puppycrawl.tools.checkstyle.checks.naming.ConstantNameCheck", "Constant Name");
    }
    ...
    public void testUnmarshallEmptyViolation() throws Exception {
        ...
        assertViolationData(violation, null, "", "", "", "");
    }
}
